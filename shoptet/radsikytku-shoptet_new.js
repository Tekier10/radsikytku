(() => {
  ...
  // --- DEBUG SECTION START ---
  // Červený box pro vizuální kontrolu verze. Pokud ho nevidíte, máte starou verzi!
  ...
  console.error("[RK] START V4 (Clean Boot)");
  // --- DEBUG SECTION END ---
  ...
  const boot = () => {
    // --- ZDE BYLA CHYBA (lock.bindHardBlock) - NYNÍ ODSTRANĚNO ---
    console.error("[RK] Booting...");
